...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    KEYMAP(PWR, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, INS, DEL,   \
           CAPS,WH_L,MS_U,WH_R,WH_U,TRNS,TRNS,TRNS,PSCR,SLCK,PAUS, UP, TRNS, BSPC,      \
           BTN3,MS_L,MS_D,MS_R,WH_D,TRNS,PAST,PSLS,HOME,PGUP,LEFT,RGHT,PENT,            \
           BTN2,VOLD,VOLU,MUTE,TRNS,TRNS,PPLS,PMNS,END, PGDN,DOWN,TRNS,TRNS,            \
